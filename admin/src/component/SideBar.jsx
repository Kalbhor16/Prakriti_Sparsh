        ...
        {menuItems.map((item) => {
          ...
          return (
            <div
              ...
              className={`group relative flex items-center justify-center md:justify-start gap-3 px-3 md:px-4 py-3 rounded-xl cursor-pointer transition-all duration-200
                ${isActive
                  ? 'bg-[#F83EAD] text-white shadow-md'
                  : 'text-gray-600 hover:bg-pink-50 hover:text-[#F83EAD]'
                }
              `}
            >
              {isActive && (
